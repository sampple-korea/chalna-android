...
The production candidate is implemented and remotely verified on GitHub Actions. [Android CI run 31311630513](https://github.com/sampple-korea/chalna-android/actions/runs/31311630513) passed policy, dependency, formatting, static-analysis, lint, JVM-test, and debug-build gates. [UI QA run 31311630522](https://github.com/sampple-korea/chalna-android/actions/runs/31311630522) passed 18 instrumented tests, 15 deterministic screenshot captures, and install/launch smoke on API 34. Physical Assistant-button, locked-screen OEM, camera-hardware latency, thermal, and high-refresh-rate results remain device-only checks; see the [QA report](docs/QA_REPORT.md).
