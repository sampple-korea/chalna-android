...
- The capture hot path begins only after an Assistant invocation, Quick Settings Tile action, notification action, or explicit user-confirmed debug capture test.
