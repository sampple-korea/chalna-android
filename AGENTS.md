...
- The capture hot path begins only after an Assistant invocation, Quick Settings Tile action, or explicit user-confirmed debug capture test. A notification action may stop an active capture but must never start one.
