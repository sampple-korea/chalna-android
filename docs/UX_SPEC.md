...
- Destructive deletion, if exposed, requires clear confirmation and identifies the local item.

## Copy rules

All Korean and English user-visible text lives in Android string resources. Use concrete verbs: “Start recording,” “Stop recording,” “Saved on this device.” Never say “secure,” “private,” or “successful” without the qualified behavior/evidence. Permission denial copy explains both consequence and settings recovery.

## UI QA views

Setup missing each requirement; ready day/night; starting; recording at 00:00 and long duration; stopping; saved; every failure; audio disabled; permission denied permanently; 200% font; RTL; TalkBack focus order; compact/expanded widths; keyguard surface. Screenshot artifacts and review are **Pending verification**.
