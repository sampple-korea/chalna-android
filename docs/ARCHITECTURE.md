...
`minSdk 29`, `compileSdk/targetSdk 36`, Java 17, AGP 9.3.1, Gradle 9.5.0, Kotlin 2.3.21, Compose BOM 2026.06.00, CameraX 1.6.1. CI alone builds/tests/packages Android artifacts.
