...
object ChalnaScreenshotStates {
    val deviceVideo = MediaItemUi(id="11111111-1111-1111-1111-111111111111", displayName="CHALNA_20260809_172300.mp4", contentUri="content://fixture/device-1", capturedAtMillis=1_786_273_800_000, durationMillis=65_000, sizeBytes=12_400_000, hasAudio=true, width=1920, height=1080)
    val vaultVideo = MediaItemUi(id="22222222-2222-2222-2222-222222222222", displayName="Private moment.mp4", contentUri="content://fixture/vault-1", capturedAtMillis=1_786_187_400_000, durationMillis=18_000, sizeBytes=4_100_000, hasAudio=false, width=1280, height=720, destination=StorageDestinationUi.CHALNA_VAULT)
    val secondDeviceVideo = MediaItemUi(id="33333333-3333-3333-3333-333333333333", displayName="CHALNA_20260809_170500.mp4", contentUri="content://fixture/device-2", capturedAtMillis=1_786_272_300_000, durationMillis=42_000, sizeBytes=8_800_000, hasAudio=true, width=1080, height=1920)
    ...
    val player = gallery.copy(player = PlayerUiState(deviceVideo, positionMillis = 24_000, durationMillis = 65_000, playing = true, phase = PlayerPhase.READY))
    val vaultPlayer = gallery.copy(player = PlayerUiState(vaultVideo, positionMillis = 4_000, durationMillis = 18_000, phase = PlayerPhase.READY))
