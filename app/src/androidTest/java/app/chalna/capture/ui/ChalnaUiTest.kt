...
internal class FakeUiDependencies(
    ...
    override fun setQuality(value: VideoQuality) {
        state.value = state.value.copy(quality = value)
    }

    override fun setAppearance(value: AppearanceMode) {
        state.value = state.value.copy(appearance = value)
    }

    override fun setHaptics(value: Boolean) {
    ...
    override fun setAutoStop(seconds: Int) {
        state.value = state.value.copy(autoStopSeconds = seconds)
    }

    override fun setMotion(value: MotionMode) {
        state.value = state.value.copy(motion = value, reducedMotion = value == MotionMode.REDUCED)
    }

    override fun reviewSetup() {
        state.value = state.value.copy(setupComplete = false)
    }
}
