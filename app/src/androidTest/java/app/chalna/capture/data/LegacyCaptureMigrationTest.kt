...
class LegacyCaptureMigrationTest {
    ...
    @Before fun setUp() {
        legacy.delete()
        backup.delete()
        database = Room.inMemoryDatabaseBuilder(context, ChalnaDatabase::class.java)
    ...
    @Test fun importsMixedV111FixtureOnceAndPreservesMalformedCount() = runBlocking {
        legacy.writeText(
            "CHALNA_INDEX_1\t1\n" +
    ...
    @Test fun duplicateIdentityIsIgnoredTransactionally() = runBlocking {
